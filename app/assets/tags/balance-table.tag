<balance-table>
    ...
    <div class="table balance-table">
        <div class="thead">
            <div class="tr">
                <div class="th" each={ title, i in titles }>{ title }</div>
            </div>
        </div>
        ...
        <div class="tfoot">
            <div class="tr">
                <div class="th">total income </div>
                <div class="td">{ total.income }</div>
            </div>
            <div class="tr">
                <div class="th">total expense </div>
                <div class="td">{ total.expense }</div>
            </div>
            <div class="tr">
                <div class="th">total</div>
                <div class="td">{ total.all }</div>
            </div>
        </div>
    </div>
